...
author: "Rutvik Gupta (1004939837), Elyssa Plaza (1004356760), Yubing Xia (1005063244), Hongbo Zhou(1004832862)"
date: "Oct 19, 2020"
url: "https://github.com/RutvikGupta/STA302-PS2"
output:
...
# Abstract
  ...
  Our team performed data diagnostics, analyzed the data, and created models from the 2017 General social survey on Family (GSS) data set to understand what variables can affect an individual's feeling of life. From the information we gathered, we observed that the data presented those who generated higher incomes ($125k and greater) ranked high feelings of life and excellent mental health than those who had lower incomes. However, the models we created concluded that mental health and house sizes have an impact on an individual's feelings of life but average working hours, income, and age do not have a statistically significant impact on an individual’s feeling of life. This is of importance because individual well-being has been a very essential aspect of life and our findings would help better understand what influences it.

# Introduction 

  This assignment will be looking at the data set of the 2017 General social survey on Family (GSS). The 2017 GSS is a sample survey with cross sectional design that was conducted from February 2nd to November 30th, 2017. The two objectives of this General social Survey is: \
 ...
 **b)** To provide information on specific social policy issues of current or emerging interest.” (CHASS)
  ...
  With the given information, our team specifically looked at feelings of life, hours of work, income, mental health, age, and household size to understand any trends from these variables. We performed descriptive and inferential analysis of the data set and models for the data. Furthermore, our team was able to conclude that the model of the average working hours, income, and age do not have a statistically significant impact on feelings of life on individuals.
 
  Our team was interested to understand the trends of what affected an individual’s feelings of life. From the GSS data set, we extracted the feelings of life, hours of work, income, mental health, age, and household size variables to understand any trends. We then created bar charts and scatter plots and was able to see that there could possibly be a trend of those with higher incomes having better rankings of life and excellent mental health, than those with lower incomes. In order to further understand the findings, we created a logistic regression model. The models concluded that mental health and house sizes have an impact on an individual's feelings of life but average working hours, income, and age does not have a statistically significant impact on an individual’s feeling of life.
 
  This paper will examine our process of looking at the data and what we found interesting about it. From the variables we choose, we will clean the data and create plots of the data to understand any trends. We will then go into detail on the model we created to conclude our final decision on any trends we have seen. The weaknesses encountered in this survey is that there are too many missing values of the labels and variables, and the complete_rate is low. This is because people may have felt that the information they were sharing was too sensitive. Therefore, some labels were either skewed or not statistically significant. Another weakness is the self-rated variables such as, self mental health state, feeling of life, as well as household size. These variables can induce bias and participants can be subjective and rate their variables by their condition at th moment, which can be highly variable. For the future, our team can specifically look at information where individuals have given honest responses. This is to avoid unnecessary skewed data and to ensure data is statistically significant. In addition to that, a new survey could be drawn to collect responses on well being. For example, we can truly understand the mental health state from the occurrence of psychological disorder, frequency of breakdown, or frequency of visits to mental health services. These added variables would help us gain a clear understanding on how an individual’s mental health state and feelings of life can be ranked.\
...
gss_select %>% 
  ...
  ggplot(mapping = aes(x = income_respondent, fill = feeling_life_rate)) +
   labs(x = "Income Bracket Groups",
       y = "Count",
       title = "Histogram of income bracket groups and their individual frequency of feeling_life" ) +
  geom_bar()
```
...
gss_select %>% 
  ...
  labs(x = "self rated mental health Groups",
       y = "Count",
       title = "Histogram of self rated mental health Groups and their individual frequency of feeling_life" ) +
  geom_bar()
```
...
5. "General Social Survey: An Overview, 2019" \
